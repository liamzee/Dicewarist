...
/* package Dicewarist-0.1.0.0 */
#ifndef VERSION_Dicewarist
#define VERSION_Dicewarist "0.1.0.0"
#endif /* VERSION_Dicewarist */
#ifndef MIN_VERSION_Dicewarist
#define MIN_VERSION_Dicewarist(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Dicewarist */
...
/* package ghc-boot-9.2.2 */
#ifndef VERSION_ghc_boot
#define VERSION_ghc_boot "9.2.2"
...
#define CURRENT_COMPONENT_ID "Dicewarist-0.1.0.0-inplace-Dicewarist"
